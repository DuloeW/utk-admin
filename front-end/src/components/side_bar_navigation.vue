    ...
    <div :class="sidebarClass" class="flex flex-col h-full max-w-[277px] bg-slate-800 p-5 relative">
        ...
        <div class="border-b-2 border-gray-300 text-white flex flex-col w-full">
            <div class="w-full flex items-center justify-evenly">
                <div class="p-1 rounded-full bg-slate-500 mr-2  ease-in-out duration-500 hover:bg-purple-600 hover:shadow-[0_0_20px_rgba(0,0,0,0.25)] hover:shadow-purple-600">
                    <AdminProfile class="text-5xl"/>
                </div>
                <div class="p-2 bg-slate-500 rounded-md ease-in-out duration-500 hover:bg-purple-600 hover:shadow-[0_0_20px_rgba(0,0,0,0.25)] hover:shadow-purple-600">
        ...
        <div class="h-full flex flex-col items-center">
            <div class="box-option w-full mt-5 text-white bg-slate-600 p-2 rounded-md">
